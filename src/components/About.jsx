      ...
      <div>
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <p className="text-blue-300">{exp.company} | {exp.period}</p>
            <p>{exp.description}</p>
          </motion.div>
        ))}
      </div>
      ...
      <div>
        {education.map((edu, index) => (
          ...
          >
            ...
            <p className="text-blue-300">{edu.school} | {edu.period}</p>
            <p>{edu.description}</p>
          </motion.div>
        ))}
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <motion.div
              ...
              className="mb-6"
            >
              <img src="/placeholder.svg?height=400&width=400" alt="Muhammad Affan" className="rounded-full w-64 h-64 mx-auto border-4 border-blue-500 shadow-lg" />
            </motion.div>
            <p className="text-base md:text-lg mb-4 text-blue-100">
