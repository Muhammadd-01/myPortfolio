      ...
      <div className="z-10 text-center px-4 w-full max-w-4xl">
        ...
        >
          <img 
            ...
            alt="Muhammad Affan" 
            className="rounded-full w-48 h-48 mx-auto border-4 border-blue-400 shadow-lg hover:shadow-2xl transition-shadow duration-300"
          />
        </motion.div>
        <motion.h1 
          custom={0}
        ...
        <motion.p
          ...
          initial={{ opacity: 0, y: 50 }}
          animate={controls}
          className="text-base md:text-lg mb-8 text-blue-100 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        >
          {services.map((service, index) => (
            <motion.div
              key={service.title}
              className="bg-blue-900 bg-opacity-50 p-6 rounded-lg text-center backdrop-filter backdrop-blur-sm hover:backdrop-blur-md transition-all duration-300"
              whileHover={{ 
                scale: 1.05, 
